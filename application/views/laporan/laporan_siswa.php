                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex justify-content-between">
                            <h4 class="my-auto font-weight-bold text-primary">Laporan Data Siswa</h4>
                        </div>
                        <div class="card-body">
                            <form name="form_filter_siswa" action="<?php echo base_url() . 'siswa/laporan_filter' ?>" method="post" class="w-50 user needs-validation mx-3 mb-4" novalidate>
                            ...
                            <div class="d-flex m-3">
                                <a target="new" href="<?php echo base_url() . 'siswa/print/' . set_value('id_kls') ?>" class="btn btn-warning shadow-sm"><i class="fas fa-print fa-sm text-white-50"></i> Print</a>
